          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-xs" style={{ color: "var(--text-tertiary)" }}>
                Fetches price data from Binance via <code className="text-[10px] px-1 py-0.5 rounded" style={{ background: "var(--bg-subtle)" }}>gl.nondet.web.render()</code> with AI validator consensus
              </p>
            </div>
          </div>
        ...
        <div className="p-5 rounded-xl" style={{ background: "var(--bg-card)", border: "1px solid var(--border-default)" }}>
          ...
          <div className="space-y-3 text-xs" style={{ color: "var(--text-tertiary)" }}>
            <div className="flex gap-3">
              ...
              <div><strong style={{ color: "var(--text-secondary)" }}>Web Fetch</strong> — The contract calls <code className="text-[10px] px-1 py-0.5 rounded" style={{ background: "var(--bg-subtle)" }}>gl.nondet.web.render(url, mode=&quot;text&quot;)</code> to pull live price data from Binance API.</div>
            </div>
            <div className="flex gap-3">
              ...
              <div><strong style={{ color: "var(--text-secondary)" }}>AI Consensus</strong> — 5 independent validators each fetch the price. <code className="text-[10px] px-1 py-0.5 rounded" style={{ background: "var(--bg-subtle)" }}>gl.eq_principle.prompt_comparative()</code> ensures they agree within 1% tolerance.</div>
            </div>
            <div className="flex gap-3">
              ...
              <div><strong style={{ color: "var(--text-secondary)" }}>On-Chain Storage</strong> — The agreed price is stored on GenLayer and viewable by anyone via the public <code className="text-[10px] px-1 py-0.5 rounded" style={{ background: "var(--bg-subtle)" }}>getPrice()</code> method.</div>
            </div>
          </div>
        </div>
      </div>
